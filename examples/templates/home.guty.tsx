<Page>
	...
	<Main layoutType="default">
		<Section className="demo-section-pad--big" layoutType="constrained" layoutContentSize="48rem">
			<QueryTitle type="archive" textAlign="center" fontSize="3-xl" />
			<Paragraph textAlign="center" fontSize="base">Notes, updates, and articles from Example Studio.</Paragraph>
			<Query
				queryId={0}
